...
# File lists
BIN_LIST    := dns-auth dns-bump dns-cleanup pspaceadd pspacedel pspacemod update-apache update-php update-element update-roundcube-carddav update-ipv4 update-ipv6 move-logs matrixinvite site-stats websites newsletter-club1
